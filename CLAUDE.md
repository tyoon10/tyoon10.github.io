...
Math mode is enabled (`hugo.yaml` → `params.features.math.enable: true`). Any literal `$` in content **will be interpreted as LaTeX**. Always escape as `\\$`:
```
WRONG: $10,000 in prizes
RIGHT: \\$10,000 in prizes
```
