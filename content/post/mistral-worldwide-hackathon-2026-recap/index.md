...
subtitle: "Recap: Mistral AI Worldwide Hackathon 2026 — New York Edition"
...
links:
  ...
  - icon: link
    icon_pack: fas
    name: Event Page
    url: https://luma.com/mistralhack-newyork?tk=W3R0u7
---
...
Mistral's bet on open-weight models (Apache 2.0 license) is not primarily about beating closed-model benchmarks. As Howard Cohen from Mistral's communications team put it: "Open source — because we want to empower the builders, giving them the technology in their hands." For builders who want to own their stack — who care about sovereignty, auditability, and ecosystem — this matters. Mistral is valued at $13.8B and positioned as critical to European AI sovereignty. Their approach gives builders something that closed APIs fundamentally cannot: control.

**Community is global, but building is local.**

Seven cities, one competition — but the magic happened in each room. NYC's builder density is unique. The conversations, the spontaneous collaborations, the in-person debugging sessions — these cannot be replicated over Zoom. The global framing gives the event its ambition. The local rooms give it its soul.
...
First, the open-source AI community does not just live on GitHub, disconnected in silos. This hackathon brought it to life — real people, in the same room, building together across seven time zones. The potential for sustained, interpersonal connection across the global AI ecosystem is real, and events like this prove it.
