...
links:
  ...
  - name: "Conversation Log"
    url: "/writings/tracing-the-minds-behind-claude-code/chat.html"
    icon: "comments"
---
...
40+ tools at ~500 tokens each would fill 20,000 to 40,000 tokens of context if loaded upfront. v0.2.8 loaded tools inline. At scale, this approach simply broke: you can't put 40 tools in the system prompt.
