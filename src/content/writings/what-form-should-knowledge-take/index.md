...
<p class="caption" style="text-align: center; margin-top: -8px; margin-bottom: 24px;">Instructions and skills are largely settled; curated knowledge remains the least-settled and highest-value layer.</p>
...
<p class="caption" style="text-align: center; margin-top: -8px; margin-bottom: 24px;">Capture, compile, package, serve, and learn—closed by human approval so the next task starts ahead.</p>
...
<p class="caption" style="text-align: center; margin-top: -8px; margin-bottom: 24px;">A versioned knowledge bundle can outlive the tool, owner, or jurisdiction around it.</p>
...
<p class="caption" style="text-align: center; margin-top: -8px; margin-bottom: 24px;">Distill the decision, evidence, scope, and supersession first; let retrieval find it afterward.</p>
...
<p class="caption" style="text-align: center; margin-top: -8px; margin-bottom: 24px;">Full-text, vector, reranking, graph, SQL, and API access paths all point inward to the curated artifact.</p>
...
<p class="caption" style="text-align: center; margin-top: -8px; margin-bottom: 24px;">Facts stay in systems of record; governed reasoning becomes the layer that supports a defensible action.</p>
